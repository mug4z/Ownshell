...
<<<<<<< Updated upstream
/*   Updated: 2023/06/17 17:35:34 by lubachma         ###   ########.fr       */
=======
/*   Updated: 2023/06/17 17:13:48 by tfrily           ###   ########.fr       */
>>>>>>> Stashed changes
/*                                                                            */
/* ************************************************************************** */
...
void	ft_maps_init(int map[4][4], int size)

{
	...
	return	(map); // ajout du return, mais a voir pour modifier
}
 /*int main ()
 {
	 int	result_map[4][4];
